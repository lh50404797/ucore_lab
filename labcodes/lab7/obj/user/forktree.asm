...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 20 11 80 00 	movl   $0x801120,(%esp)
  ...
  800062:	e8 7e 00 00 00       	call   8000e5 <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 3a 11 80 00 	movl   $0x80113a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 3c 11 80 00 	movl   $0x80113c,(%esp)
  ...
  8000b2:	e8 2e 00 00 00       	call   8000e5 <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 3a 11 80 00 	movl   $0x80113a,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e6:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800635:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  800740:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  800747:	00 
  ...
  80076c:	75 05                	jne    800773 <vprintfmt+0x1ad>
                p = "(null)";
  80076e:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  801039:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  801040:	00 
...
forktree(const char *cur) {
  ...
  801091:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
...
main(void) {
  ...
  8010ce:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  8010d5:	00 
  8010d6:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
  8010dd:	e8 36 f0 ff ff       	call   800118 <cprintf>
    sleep(SLEEP_TIME);
  8010e2:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8010e9:	e8 be f2 ff ff       	call   8003ac <sleep>
    forktree("");
  8010ee:	c7 04 24 3e 14 80 00 	movl   $0x80143e,(%esp)
  8010f5:	e8 81 ff ff ff       	call   80107b <forktree>
    return 0;
